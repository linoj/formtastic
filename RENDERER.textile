...
_input_ will include only one of the keys :input, :items, or :chronos.
...
You can also specify the renderer on a case by case basis using the semantic_form_for :renderer option, overriding the configuration setting. The value is a symbol representing the module. For example 
<pre>
  :renderer => :erb 
</pre>
would load the Formtastic::ErbRenderer module, while 
<pre>
  :renderer => :classic_formtastic 
</pre>
would load Formtastic::ClassicFormtasticRenderer
...
<pre>
  :inline       inputs group is wrapped in a <div> and the items are in <p> tags
</pre>
...
<pre>
  <li class="inputs" name="Full Name">
    ...
    <div>
      <p class="string required" id="site_page_first_name_input">
        <label for="site_page_first_name">First<abbr title="required">*</abbr></label><br>
        <input id="site_page_first_name" name="site_page[first_name]" size="15" type="text"><br>
      </p>
      <p class="string required" id="site_page_middle_name_input">
        <label for="site_page_middle_name">Middle<abbr title="required">*</abbr></label><br>
        <input id="site_page_middle_name" name="site_page[middle_name]" size="5" type="text"><br>
      </p>
      <p class="string required" id="site_page_last_name_input">
        <label for="site_page_last_name">Last<abbr title="required">*</abbr></label><br>
        <input id="site_page_last_name" name="site_page[last_name]" size="15" type="text"><br>
      </p>
    </div>
  </li>
</pre>
