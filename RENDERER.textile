...
h3. New semantic_form_for options

You can also specify the renderer on a case by case basis using a new semantic_form_for :renderer option. The value is a symbol representing the module. For example :renderer => :erb would load the Formtastic::ErbRenderer module, while :renderer => :classic_formtastic would load Formtastic::ClassicFormtasticRenderer
...
* option to switch renderer for specific form, inputs, or input
